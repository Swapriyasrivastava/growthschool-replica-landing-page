        ...
        <div className="text-center pt-16 pb-8">
          ...
          <div className="flex items-center justify-center space-x-4 mb-12">
            <img 
              ...
              className="h-12"
            />
            <div className="flex items-center space-x-2 bg-white/10 border border-white/20 px-4 py-2 rounded-lg">
              ...
              <span className="bg-blue-600 text-white px-3 py-1 rounded text-xs font-medium">Top Startup India</span>
            </div>
          </div>
